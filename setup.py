...
name = 'trytonar_sale_printery_budget'
...
setup(name=name,
    ...
    package_dir={'trytond.modules.sale_printery_budget': '.'},
    packages=[
        'trytond.modules.sale_printery_budget',
        'trytond.modules.sale_printery_budget.tests',
        ],
    package_data={
        'trytond.modules.sale_printery_budget': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    sale_printery_budget = trytond.modules.sale_printery_budget
    """,
    test_suite='tests',
